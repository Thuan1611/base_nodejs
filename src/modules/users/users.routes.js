...
import userControlller from "./userController.js";
...
userRoutes.post(
  "/signup",
  validBodyRequest(signUpSchema),
  handleAsync(userControl.signUp)
);
userRoutes.post(
  "/signin",
  validBodyRequest(signInSchema),
  handleAsync(userControl.signIn)
);
...
userRoutes.get(
  "/get-profile",
  jwtMiddleware,
  handleAsync(userControl.getProfile)
);
userRoutes.post(
  "/update-profile",
  jwtMiddleware,
  handleAsync(userControl.updateProfile)
);
